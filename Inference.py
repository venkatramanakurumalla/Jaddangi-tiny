# ==============================================================================
# JADDANGI 44M · HUGGING FACE INFERENCE TEST (PyTorch 2.6 Fixed)
# ==============================================================================
...
import __main__ # 👈 PyTorch సెక్యూరిటీ ఫిక్స్ కోసం

DEVICE = "cuda" if torch.cuda.is_available() else "cpu"
print(f"⚡ Running on: {DEVICE.upper()}\n")

# 1. 44M Architecture Config
@dataclass
class ModelOutput:
...
# 👈 The PyTorch 2.6 Hack (పాత క్లాస్ పేరును బైపాస్ చేయడానికి)
...
# ==============================================================================
# 2. Download from Hugging Face & Load Safely
# ==============================================================================
...
# 👈 PyTorch 2.6 Fix: weights_only=False ఎందుకంటే ఫైల్ మనదే!
